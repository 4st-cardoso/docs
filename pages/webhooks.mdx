...
description: 'Eventos e payloads de webhooks da API v1 da 4SeletPay.'
icon: 'webhook'
---
...
Pense nos webhooks como **"mensagens enviadas pela 4SeletPay para o seu
...
- A 4SeletPay dispara requisições `POST` para essa URL sempre que algo
  importante acontece
...
1. Sua URL de webhook é algo como\
   `https://meusite.com/webhooks/4seletpay?webhookSecret=SEU_SECRET`
