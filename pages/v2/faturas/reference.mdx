...
Uma fatura em `requires_action` **nem sempre** traz um `next_action`: quando o código de verificação já foi confirmado ou expirou, o campo vem `null`. Trate o nulo em vez de assumir que o objeto existe.
