...
| `amount`                      | integer | Valor da cobrança, em centavos de real                             |
...
| `amount_refunded`             | integer | Total já estornado, em centavos de real                            |
| `amount_refundable`           | integer | Quanto ainda pode ser estornado, em centavos de real. `0` se a cobrança não estiver paga |
...
|----------|---------|------|----------------------------------------------------------------------|
| `amount` | integer | Não  | Valor a estornar, em centavos de real (mín. `1`). Se omitido, estorna todo o saldo restante |
