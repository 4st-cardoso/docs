...
<Warning>
  O `card_id` só é aceito se o cartão pertencer à **mesma conta** da cobrança. Um `card_id` de **outra conta** é rejeitado com **422**, assim como um cartão **excluído** ou inexistente.
</Warning>
